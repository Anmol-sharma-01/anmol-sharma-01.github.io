...
- Components: `text-effect`, `magnetic`, `spotlight`, `text-loop`, `border-trail`, and `tilt` from `components/core/`.
...
- Sources: `src/data/contents/animated-components/shimmer-button/base.tsx`, `copy-confirm/base.tsx`, `fluid-tabs/base.tsx`, and `reveal-copy/base.tsx`.
...
Additional adaptations share a pause/reduced-motion preference, stop the text loop outside the viewport, and limit tilt to mouse input. Watermelon's reveal-copy character springs are used for public introductory text without its masking or payment-card behavior.
